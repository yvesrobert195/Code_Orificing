...
Pb.Var.nvars = Pb.Var.nass+Pb.Var.nass*Pb.Var.npossflows+Pb.Var.npossflows+1; % number of total variables
...
fprintf('*********************************************************************\n')
Pb=Copy_of_make_constraints(Pb,Input,Coolant,Geometry);

% Solve
fprintf('*********************************************************************\n')
fprintf('Solving with CPLEX\n');
fprintf('*********************************************************************\n')
prio=[zeros(Pb.Var.nvars-1,1);1];
Pb.CPLEX.opts.mip.ordertype=prio;
