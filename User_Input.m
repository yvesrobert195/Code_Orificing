...
%% Files
Input.path='/Users/yvesrobert/Desktop/Stage/Control_rods/try/Results/base/';
Input.Core='A'; % Name of the core : A, bnb, A_one_row...
Input.names={'det0';'det1'};%;'det2';'det3'};  % det files to study

%% User parameters
Input.constant_properties=1; % 1 : Take average values for coolant properties; 0 : Create tables with variable coolant properties
...
Pb.CPLEX.workmem = 8000; % Maximum RAM to allocate for CPLEX 
